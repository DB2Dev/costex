...
def query_report_page(dictionary):
    ...
    options = {
        ...
        "series": [
            {
                # add data_values to the chart and make sure to style the min and max values to be different
                "data":[{"value":min_value, "itemStyle": {"color": "#03a900"}} ,*data_values, {"value":max_value, "itemStyle": {"color": "#d91600"}}],
                "type": "bar",
                "barMinHeight": "10"
            }
        ]
